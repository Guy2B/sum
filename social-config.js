...
window.SIGMA_SOCIAL_CONFIG = Object.freeze({
  ...
  providers: Object.freeze({
    ...
    x: Object.freeze({ enabled: true, configured: false, clientId: 'eE1uTXR6MjQybmd6c0o2ejkwMXE6MTpjaQ', label: 'X', capabilities: Object.freeze(['profile', 'posts']), note: 'Requires X OAuth 2.0 PKCE and an API access tier.' })
  })
});

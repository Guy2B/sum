...
(() => {
  ...
  async function importGmail(){
    const list=await api(`https://gmail.googleapis.com/gmail/v1/users/me/messages?maxResults=${Number(cfg.gmailMaxMessages)||100}&q=${encodeURIComponent('newer_than:30d')}`,{},scopes.gmail);
